...
MODEL_BEST_PATH = os.path.join(SAVE_DIR, "hybrid_model.pth")
LOG_PATH        = os.path.join(SAVE_DIR, "hybrid_epoch_log.csv")
...
def run_training():
    ...
    print(f"\n{'='*50}")
    print(f"  Hybrid EF Model – Training")
    print(f"  Device : {device}  |  Epochs : {EPOCHS}  |  Batch : {BATCH_SIZE}")
    print(f"{'='*50}\n")

    # Dataset
    train_dataset = HybridEchoDataset(split=0)
    val_dataset   = HybridEchoDataset(split=1)
